...
text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur a tellus ut arcu gravida porta eget a lacus. Curabitur ornare varius turpis, ultricies mollis sem convallis in. Nunc scelerisque lacinia risus sit amet aliquam."

new_text = text.upper()

print(f'С учетом регистра: {len(set(new_text.split()))}')
print(f'Без учета регистра: {len(set(text.split()))}')
