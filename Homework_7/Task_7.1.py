...
def is_rhythmic(str1: str) -> bool:
    vowels = ['а', 'и', 'е', 'ё', 'о', 'у', 'ы', 'э', 'ю', 'я']
    list1 = str1.split(' ')
    vow_count = [0]*len(list1)
    for i in range(len(list1)):
        for char in list1[i]:
            if char in vowels:
                vow_count[i] += 1
    for i in range(1, len(vow_count)):
        if vow_count[i] != vow_count[i-1]:
            return False
        return True


print(is_rhythmic("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"))
